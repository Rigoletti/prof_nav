...
const KlimovTest = () => {
    ...
    const handleAnswer = async (action = 'next') => {
        ...
        try {
            const response = await api.post('/tests/klimov/answer', {
                ...
                <Card sx={{ mb: 4, borderRadius: 3, boxShadow: '0 20px 40px rgba(0, 0, 0, 0.08)' }}>
                    <CardContent sx={{ p: 4 }}>
                        <Box sx={{ display: 'flex', alignItems: 'center', gap: 2, mb: 3 }}>
                            ...
                            <Box sx={{ ml: 'auto' }}>
                                <Tooltip title="Ответьте на вопрос">
                        ...
                        <Stack spacing={2} sx={{ mb: 4 }}>
                            <Button
                                fullWidth
                                variant={currentAnswer === '+' || initialAnswer === '+' ? "contained" : "outlined"}
                                onClick={() => !submitting && setCurrentAnswer('+')}
                                disabled={submitting}
                                ...
                                sx={{
                                    ...
                                    fontSize: '1.1rem',
                                    fontWeight: 600,
                                    backgroundColor: (currentAnswer === '+' || initialAnswer === '+') ? '#10b981' : 'transparent',
                                    borderColor: (currentAnswer === '+' || initialAnswer === '+') ? '#10b981' : 'grey.300',
                                    color: (currentAnswer === '+' || initialAnswer === '+') ? 'white' : 'text.primary',
                                    '&:hover': {
                                        backgroundColor: (currentAnswer === '+' || initialAnswer === '+') ? '#059669' : alpha('#10b981', 0.1),
                                        borderColor: '#10b981',
                                    }
                                }}
                            >
                            ...
                            <Button
                                ...
                                sx={{
                                    ...
                                    fontSize: '1.1rem',
                                    fontWeight: 600,
                                    backgroundColor: (currentAnswer === '-' || initialAnswer === '-') ? '#ef4444' : 'transparent',
                                    borderColor: (currentAnswer === '-' || initialAnswer === '-') ? '#ef4444' : 'grey.300',
                                    color: (currentAnswer === '-' || initialAnswer === '-') ? 'white' : 'text.primary',
                                    '&:hover': {
                                        backgroundColor: (currentAnswer === '-' || initialAnswer === '-') ? '#dc2626' : alpha('#ef4444', 0.1),
                                        borderColor: '#ef4444',
                                    }
                                }}
                            >
                                        ...
                                        <Card key={index} variant="outlined">
                                            <CardContent sx={{ p: 2 }}>
                                                <Box sx={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', mb: 1 }}>
                                                    ...
                                                    <Chip 
                                                        icon={item.answer === '+' ? <CheckCircleIcon /> : <CancelIcon />}
                                                        label={item.answer === '+' ? 'Да' : 'Нет'} 
                                                        size="small"
